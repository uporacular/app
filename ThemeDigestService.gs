 ...
 * ============================================================================
 * PROJETO: Up Oracular
 * TEMA: Leitura e trilhas formativas
 *
 * DESCRIÇÃO:
...
var THEME_NEWS_CFG = {
  THEME: 'Leitura e trilhas formativas',
  QUERY: '"incentivo a leitura" OR "mediacao de leitura"',
  AUDIENCE: 'leitoras e leitores que seguem trilhas de leitura personalizadas e interdisciplinares',
