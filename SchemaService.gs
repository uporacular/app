...
var PROJECT_SCHEMA_DEFINITIONS = {"ACCESSLOG":{"entity":"ACCESSLOG","sheetName":"AccessLog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"AccessController.gs"},"ACERVO":{"entity":"ACERVO","sheetName":"Acervo","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"AcervoService.gs"},"AUDIT_LOGS":{"entity":"AUDIT_LOGS","sheetName":"Audit_Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"},"CATALOGO":{"entity":"CATALOGO","sheetName":"Catálogo","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"RecommendationEngine.gs"},"EXPORTLOG":{"entity":"EXPORTLOG","sheetName":"Exportlog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"DataExporter.gs"},"FEEDBACKS":{"entity":"FEEDBACKS","sheetName":"Feedbacks","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"FeedbackCollector.gs"},"HISTORICOTRILHAS":{"entity":"HISTORICOTRILHAS","sheetName":"HistoricoTrilhas","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"TrailHistory.gs"},"IMPORTLOG":{"entity":"IMPORTLOG","sheetName":"ImportLog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"DataImporter.gs"},"LEITURAS":{"entity":"LEITURAS","sheetName":"Leituras","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"PatternDetector.gs"},"LINKMAP":{"entity":"LINKMAP","sheetName":"LinkMap","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"InterdisciplinaryLinker.gs"},"LOGS":{"entity":"LOGS","sheetName":"Logs","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"BackendMaturity.gs"},"NOTIFICATIONLOG":{"entity":"NOTIFICATIONLOG","sheetName":"NotificationLog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"NotificationSender.gs"},"PERFIS":{"entity":"PERFIS","sheetName":"Perfis","headers":["ID","Name","Description","Status","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"DataCleaner.gs"},"PERMISSOES":{"entity":"PERMISSOES","sheetName":"Permissoes","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"AccessController.gs"},"REPORTLOG":{"entity":"REPORTLOG","sheetName":"Reportlog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"ReportGenerator.gs"},"SESSIONLOG":{"entity":"SESSIONLOG","sheetName":"Sessionlog","headers":["ID","Timestamp","Level","Action","Entity","RecordID","UserID","Message","Details","CreatedAt"],"required":["ID"],"identifier":"ID","source":"BackendMaturity.gs"},"SETTINGS":{"entity":"SETTINGS","sheetName":"Settings","headers":["Key","Value","Description","Scope","UpdatedAt","UpdatedBy"],"required":["Key"],"identifier":"Key","source":"baseline"},"USERS":{"entity":"USERS","sheetName":"Users","headers":["ID","Name","Email","Username","PasswordHash","Role","Status","LastLoginAt","CreatedAt","UpdatedAt"],"required":["ID"],"identifier":"ID","source":"baseline"}};
