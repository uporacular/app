      ...
      var PedagogicalTraceabilityService = (function () {
        var CFG = {
          projectName: "Up Oracular",
          shortName: "Up Oracular",
          theme: "curadoria literaria e trilhas de leitura",
          sourceStrategy: "A recomendacao deve ligar historico de leitura, catalogo real e justificativa pedagogica curta, sem impor canon nem gosto correto.",
          learnerAgency: "O estudante escolhe o proximo livro; a IA funciona como curadora explicavel e reversivel.",
          evidenceLabel: "historico de leitura, interesses declarados e catalogo disponivel",
          productLabel: "recomendacao ou guia de antecipacao de leitura",
          reviewFocus: [
  "A recomendacao esta disponivel no acervo real?",
  "A justificativa mostra continuidade e desafio moderado?",
  "O texto preserva autonomia de escolha do leitor?",
  "A trilha evita reduzir literatura a ranking de dificuldade?"
]
        };
